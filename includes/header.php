<?php 
  ...
  session_start();
  define("APPURL", "http://localhost/tour and travel");

  
  //images dirs
  define("COUNTRIESIMAGES", "http://localhost/tour and travel/admin-panel/countries-admins/images_countries");
  define("CITIESIMAGES", "http://localhost/tour and travel/admin-panel/cities-admins/images_cities");
